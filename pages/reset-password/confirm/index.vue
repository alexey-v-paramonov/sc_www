    ...
    <NuxtLayout name="auth">
      ...
      <v-container>
        <v-row no-gutters md="6">
          <v-col>&nbsp;</v-col>
          <v-col md="6">
            <h1 v-if="!resetConfirmDone">{{ $t('password_reset.new_pass') }}</h1>
            <!-- Confirm form -->
            <v-form v-if="!resetConfirmDone" @submit.prevent="resetConfirmPassword" :disabled="isPassResetConfirmSubmitting">
