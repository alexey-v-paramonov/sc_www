          ...
          <template v-if="isSelfHosted()">
            ...
            <v-row>
              ...
              <v-col md="11">
                ...
                <template v-else>
                  <b>499 рублей</b> в месяц, включено до 5 станций.<br /> Каждая дополнительная станция - дополнительно 80
                  рублей. Если, например, всего станций 8 - то стоимость составит 499 + 3 * 80 = 739 рублей в месяц.
                </template>
