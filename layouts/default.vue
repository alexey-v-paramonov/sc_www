...
<template>
  <v-app>
    <!------Sidebar-------->
    <v-navigation-drawer left elevation="0" app class="leftSidebar" v-model="sDrawer"><!-- :rail="rail"
        permanent
        absolute
        @click="rail = false"
      ...
      <div>
        <perfect-scrollbar class="scrollnavbar">
          <v-list>
            <v-list-item to="/" prepend-icon="custom:home" rounded class="mb-1" color="primary"
              :title="$t('nav_home')"></v-list-item>
            <v-list-subheader color="darkText" class="smallCap text-uppercase text-subtitle-2 mt-5 font-weight-bold"
              :title="$t('nav_streams')"></v-list-subheader>
            <v-list-item to="/radio" prepend-icon="custom:radio" rounded class="mb-1" color="primary"
              :title="$t('nav_radio')"></v-list-item>

            <!-- Application -->
            <v-list-subheader color="darkText" class="smallCap text-uppercase text-subtitle-2 mt-5 font-weight-bold"
              :title="$t('nav_apps')"></v-list-subheader>
            <v-list-item to="/apps/android" prepend-icon="custom:android" rounded class="mb-1" color="primary"
              :title="$t('nav_android')"></v-list-item>
            <v-list-item to="/apps/ios" prepend-icon="custom:apple" rounded class="mb-1" color="primary"
          ...
          <v-list-item to="/catalog" prepend-icon="mdi-bookmark-box-multiple" rounded class="mb-1" active-color="primary" :title="$t('nav_catalog_stations')"></v-list-item> -->
            ...
            <!-- Billing -->
            <v-list-subheader color="darkText" class="smallCap text-uppercase text-subtitle-2 mt-5 font-weight-bold"
              :title="$t('nav_billing')"></v-list-subheader>
            <v-list-item to="/billing" prepend-icon="custom:payment " rounded class="mb-1" color="primary"
              :title="$t('nav_balance')"></v-list-item>

            <!-- Settings -->
            <v-list-subheader color="darkText" class="smallCap text-uppercase text-subtitle-2 mt-5 font-weight-bold"
              :title="$t('nav_settings')"></v-list-subheader>
            <v-list-item to="/settings" prepend-icon="custom:account" rounded class="mb-1" color="primary"
              :title="$t('nav_settings_account')"></v-list-item>
    ...
    border-bottom-width: 1px;">
      ...
      <v-hover>
        <template v-slot:default="{ isHovering, props }">
          <v-btn v-bind="props" v-if="user" icon :color="isHovering ? 'primary' : 'grey-darken-1'"
            class="bg-grey-lighten-5 ml-4 mr-4" variant="text" :title="$t('logout')" @click="Logout()" size="x-small">
            <!--{{ $t('logout')}}-->
      ...
      <v-progress-linear :active="Boolean(stateUI.loading)" :indeterminate="Boolean(stateUI.loading)" absolute bottom
